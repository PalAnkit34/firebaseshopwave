...
export const HOME_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Fill your surroundings with peace, devotion, and freshness with the Live Touch Premium Agarbatti Combo Pack. This set includes 6 distinct fragrances, each crafted to provide a soothing and long-lasting aroma.',
