    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Link href="/search?category=Tech" className="relative block h-32 md:h-48 overflow-hidden rounded-xl group">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-2">
                    <h3 className="text-lg md:text-xl font-bold text-white text-center">Tech Accessories</h3>
                </div>
            </Link>
            <Link href="/search?category=Home" className="relative block h-32 md:h-48 overflow-hidden rounded-xl group">
                ...
                <div className="absolute inset-0 bg-black/40"></div>
                <div className="absolute inset-0 flex items-center justify-center p-2">
                    <h3 className="text-lg md:text-xl font-bold text-white text-center">Home Accessories</h3>
                </div>
            </Link>
            <Link href="/search?category=Ayurvedic" className="relative block h-32 md:h-48 overflow-hidden rounded-xl group">
                ...
                <div className="absolute inset-0 bg-black/40"></div>
                <div className="absolute inset-0 flex items-center justify-center p-2">
                    <h3 className="text-lg md:text-xl font-bold text-white text-center">Ayurvedic Essentials</h3>
                </div>
            </Link>
        </div>
      </section>
