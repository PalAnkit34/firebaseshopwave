             ...
             if (!opts.category) {
                 return <CategoryHeader 
                    ...
                    categories={[
                        ...
                        { name: 'Food & Drinks', href: '/search?category=Food%20%26%20Drinks', image: 'https://images.unsplash.com/photo-1551024709-8f232a510e52?q=80&w=800&auto=format&fit=crop', dataAiHint: 'delicious food' },
